    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item active" href=#>jakarta Utara</a>
        ...
        <div class="container-fluid bg-white">
          ...
          <h6 class="mb-0 text-danger pl-3">Jakarta Utara</h6>
          </div>

          <!-- Content Row -->
          <div class="row justify-content-between mb-4 pl-3">
            <h5 class=" tx-spacing--1">
                Jakarta Utara Dalam Angka
            </h5>
          ...
          <div class="col-xl-4 col-md-6 mb-4">
            <div class="card-header"> 
                <div class="d-sm-flex justify-content-between px-0">
                  <h6 class="m-0 font-weight-bold text-white">Kota Jakarta Utara</h6>
            </div>  
          </div>
            <div class="card bg-white">   
              <img class="card-img-top" src='assets\img\jakut2.jpg' alt="Card image cap">
              <div class="card-body">
              ...
              <table class="table  table-dashboard table-dashboard-one">
                ...
                <tbody>
                      <tr>
                        ...
                        <td class="text-right text-dark">32</td>
                      </tr>
                      <tr>
                        <td class="text-sm text-dark">Kecamatan</td>
                        <td class="text-right text-dark">6</td>
                      </tr>
                      <tr>
