    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid bg-white">
          ...
          <div class="row justify-content-between mb-4 pl-3">
            <h5 class=" tx-spacing--1">
                Dashboard Layanan Panggilan Jakarta Siaga 112
            </h5>
        ...
        <div class="row px-4">
          ...
          <div class="col-xl-4 col-md-4 mb-4">
            <div class="card bg-white">
              <div class="card-body">
                <div class="text-xs font-weight-bold text-dark text-uppercase">Panggilan Masuk
                </div>
                  <div class="d-flex d-lg-block d-xl-flex align-item-end">
                    <h4 class="tx-rubik mb-0 mr-1 text-success ">118012 Success
                    </h4>
                      <p class="tx-xs pt-1 mb-0">
                        <span class="text-medium text-danger">360 Abandon
                        </span>
                      </p>
                  </div>      
        ...
        <div class="col-xl-4 col-md-4 mb-4">
            <div class="card bg-white ">
              <div class="card-body">
                <div class="text-xs font-weight-bold text-dark text-uppercase">Complete Call</div>
                  <div class="d-flex d-lg-block d-xl-flex align-item-end">
                    <h4 class="tx-normal tx-rubik mb-0 1h-1 mr-1">13295 Call</h4>
                      <p class="tx-xs pt-1 mb-0">
                        <span class="text-medium text-success">11%
                        </span> of success call
                      </p>
                  </div>
        ...
        <div class="col-xl-4 col-md-4 mb-4">
            <div class="card bg-white ">
              <div class="card-body">
                <div class="text-xs font-weight-bold text-dark text-uppercase">Prank & Drop call</div>
                  <div class="d-flex d-lg-block d-xl-flex align-item-end">
                    <h4 class="tx-normal tx-rubik mb-0 1h-1 mr-1">104717 Call</h4>
                      <p class="tx-xs pt-1 mb-0">
                        <span class="text-medium text-danger">89%
                        </span>of success call
                      </p>
                  </div>
                  <div class="chart-three">
            ...
            <div class="card mb-4">
              ...
              <div class="card-header"> 
                <div class="d-sm-flex justify-content-between px-0">
                  <h6 class="m-0 font-weight-bold text-white">Kinerja Layanan</h6>
        ...
        <div class="col-xl-8 col-lg-7">
          <div class="card mb-4">
            ...
            <div class="card-header">
              <div class="d-sm-flex justify-content-between px-0">
                <h6 class="m-0 font-weight-bold text-white">Jumlah Panggilan</h6>
                <div class="dropdown no-arrow">
                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                </a>
      ...
      <!--akhir baris pertama-->
        ...
        <div class="col-xl-3 col-lg-5">
            <div class="card mb-4">
              ...
              <div class="card-header"> 
                <div class="d-sm-flex justify-content-between px-0">
                  <h6 class="m-0 font-weight-bold text-white">Success Call</h6>
                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                    </a>
              ...
              <div class="card-body">
                ...
                <div class="mt-0 text-center small">
                  <span class="mr-2">
                    <i class="fas fa-circle text-danger"></i> Prank Call
                  </span>
                </div>
                <div class="mt-0 text-center small">
                  <span class="mr-2">
      ...
      <div class="col-xl-3 col-lg-5">
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="mt-0 text-center small">
                  <span class="mr-2">
                    <i class="fas fa-circle text-danger"></i> Emergency Call
                  </span>
                </div>
                <div class="mt-0 text-center small">
                  <span class="mr-2">
                    <i class="fas fa-circle text-warning"></i> Non-Emergency Call
                  </span>
              </div>
            </div>
          </div>
