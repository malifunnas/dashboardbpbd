    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="nav nav-tabs">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item active" href=#>Jakarta Barat</a>
        ...
        <div class="container-fluid bg-white">
          ...
          <h6 class="mb-0 text-danger pl-3">Jakarta Barat</h6>
          </div>

          <!-- Content Row -->
          <div class="row justify-content-between mb-4 pl-3">
            <h5 class=" tx-spacing--1">
                Jakarta Barat Dalam Angka
            </h5>
          ...
          <div class="col-xl-4 col-md-6 mb-4">
            <div class="card-header"> 
                <div class="d-sm-flex justify-content-between px-0">
                  <h6 class="m-0 font-weight-bold text-white">Kota Jakarta Barat</h6>
            </div>  
          </div>
            <div class="card bg-white">   
              <img class="card-img-top" src='assets\img\jakbar2.jpg' alt="Card image cap">
              <div class="card-body">
              ...
              <table class="table  table-dashboard table-dashboard-one">
                ...
                <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-right text-dark">51</td>
                      </tr>
                      <tr>
                        <td class="text-sm text-dark">Kantor Polisi</td>
                        <td class="text-right text-dark">7</td>
                      </tr>
                      <tr>
                        <td class="text-sm text-dark">Ambulance Gawat Darurat</td>
                        <td class="text-right text-dark">13</td>
                      </tr>
