...
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: ["25Nov", "26Nov", "27Nov", "28Nov", "29Nov", "30Nov"],
    datasets: [{
      label: "Drop Call",
      lineTension: 0.3,
    ...
    tooltips: {
      ...
      callbacks: {
        label: function(tooltipItem, chart) {
          ...
          return datasetLabel + ': ' + number_format(tooltipItem.yLabel) + ' panggilan';
        }
      }
    }
  }
